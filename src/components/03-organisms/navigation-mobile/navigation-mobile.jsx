		...
		<nav className={ `${ className } navigation-mobile` } ref={ navigationMobileRef }>
			<div className="navigation-mobile__bar bar">
				<Link className="bar__logo-link" href="/">
					<img className="bar__logo" src="/logos/heller-grafik/full.svg" alt="heller grafik"/>
				</Link>
			...
			<div className="navigation-mobile__menu menu" onClick={ handleToggle }>
				<ul className="menu__list list">
					<li className="list__item">
						<Link className="list__item-link default-link" href="/projects">Projekte</Link>
					</li>
					<li className="list__item">
						<Link className="list__item-link default-link" href="/info">Info</Link>
					</li>
					<li className="list__item">
						<Link className="list__item-link default-link" href="/contact">Kontakt</Link>
					</li>
				</ul>
			</div>
		</nav>
